...
nnoremap <expr>  p (len(system('git rev-parse')) ? ':Files' : ':GFiles --exclude-standard --others --cached')."\"
nnoremap  l :Lines 
nnoremap  rg :Rg 
nnoremap  bl :BLines 
nnoremap  f :Files 
...
set incsearch
set laststatus=2
set runtimepath=~/.vim,~/.vim/bundle/Vundle.vim,~/.vim/bundle/tagbar,~/.vim/bundle/editorconfig-vim,~/.vim/bundle/dracula,~/.vim/bundle/vaxe,~/.vim/bundle/fzf,~/.vim/bundle/fzf.vim,~/.vim/bundle/vim-polyglot,~/.vim/bundle/coc.nvim,~/.vim/bundle/vim-easymotion,~/.vim/bundle/vim-gitgutter,/usr/local/share/vim/vimfiles,/usr/local/share/vim/vim82,/usr/local/share/vim/vimfiles/after,~/.vim/after,~/.vim/bundle/Vundle.vim,~/.vim/bundle/Vundle.vim/after,~/.vim/bundle/tagbar/after,~/.vim/bundle/editorconfig-vim/after,~/.vim/bundle/dracula/after,~/.vim/bundle/vaxe/after,~/.vim/bundle/fzf/after,~/.vim/bundle/fzf.vim/after,~/.vim/bundle/vim-polyglot/after,~/.vim/bundle/coc.nvim/after,~/.vim/bundle/vim-easymotion/after,~/.vim/bundle/vim-gitgutter/after
set shiftwidth=2
set shortmess=filnxtToOSc
set smartcase
set statusline=%<%f\ %h%m%r%=%-14.(%l,%c%V%)\ %P%#NormalColor#%{(mode()=='n')?'\ \ NORMAL\ ':''}%#InsertColor#%{(mode()=='i')?'\ \ INSERT\ ':''}%#ReplaceColor#%{(mode()=='R')?'\ \ REPLACE\ ':''}%#VisualColor#%{(mode()=='v')?'\ \ VISUAL\ ':''}
set tabstop=2
set termguicolors
set timeoutlen=3000
set ttimeoutlen=100
...
silent only
silent tabonly
cd ~/projects/games/autonomous-game
...
setlocal makeprg=cd\ ~/projects/games/autonomous-game\ &&haxe\ ~/projects/games/autonomous-game/build.hxml\ 2>&1
setlocal matchpairs=(:),{:},[:]
setlocal modeline
setlocal modifiable
...
252
normal! zo
let s:l = 224 - ((34 * winheight(0) + 31) / 62)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
224
normal! 05|
lcd ~/projects/games/autonomous-game
wincmd w
argglobal
if bufexists("~/projects/games/autonomous-game/src/Game.hx") | buffer ~/projects/games/autonomous-game/src/Game.hx | else | edit ~/projects/games/autonomous-game/src/Game.hx | endif
let s:cpo_save=&cpo
set cpo&vim
nmap <buffer>  hp <Plug>(GitGutterPreviewHunk)
nmap <buffer>  hu <Plug>(GitGutterUndoHunk)
...
3568
normal! zo
let s:l = 909 - ((81 * winheight(0) + 31) / 62)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
909
...
exe 'vert 2resize ' . ((&columns * 81 + 81) / 163)
tabnext 1
badd +538 ~/projects/games/autonomous-game/Main.hx
badd +913 ~/projects/games/autonomous-game/src/Game.hx
badd +31 ~/projects/games/autonomous-game/build-animations.js
badd +333 ~/projects/games/autonomous-game/src/res/sprite_sheet.json
badd +105 ~/projects/games/autonomous-game/src/SpriteBatchSystem.hx
badd +62 ~/projects/games/autonomous-game/src/LightingSystem.hx
badd +29 ~/.vimrc
badd +342 ~/projects/games/autonomous-game/src/Entity.hx
badd +13 ~/projects/games/autonomous-game/build.hxml
badd +38 ~/projects/games/autonomous-game/src/EntityStats.hx
badd +150 ~/projects/games/heaps/h2d/col/Bounds.hx
